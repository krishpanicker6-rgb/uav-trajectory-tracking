...
print(f"Circle RMSE: {rmse:.4f} m")
print(f"Circle Max Error: {max_error:.4f} m")

plt.figure()
plt.plot(time, error)
plt.xlabel("Time (s)")
plt.ylabel("Tracking Error (m)")
plt.title("Circle Mission Tracking Error vs Time")
plt.grid(True)
plt.show()
...
ax.set_ylabel("Y (m)")
ax.set_zlabel("Z (m)")
ax.set_title("Circle Mission 3D Trajectory Tracking")
ax.legend()
